...
exports.ACDepartmentController = void 0;
...
const dept_constant_1 = require("./dept.constant");
// createController
const createACDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const ACDepartmentData = __rest(req.body, []);
    const result = yield dept_service_1.ACDepartmentService.createACDepartment(ACDepartmentData);
...
const getAllDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pgPicker_1.default)(req.query, dept_constant_1.departmentFilterableFields); //filtering
    const paginationOptions = (0, pgPicker_1.default)(req.query, pagination_1.paginationField);
    const result = yield dept_service_1.ACDepartmentService.getAllDepartment(filters, paginationOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
        message: '✅All Department retrieved successfully!',
...
const getOneDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield dept_service_1.ACDepartmentService.getADepartment(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const id = req.params.id;
    const result = yield dept_service_1.ACDepartmentService.updateDepartment(id, updatedData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const deleteDepartment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield dept_service_1.ACDepartmentService.deleteDepartment(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
exports.ACDepartmentController = {
    createACDepartment,
    getAllDepartment,
    getOneDepartment,
    updateDepartment,
